...
clear
echo ""
echo "Stellarnode Pterodactyl installer @ v1.0"
echo "Copyright 2024, Niels Maes, <nielsmaes2005@gmail.com>"
echo ""
echo "Dit script is niet verbonden met Pterodactyl paneel of het Pterodactyl team."
echo ""
oscheck
